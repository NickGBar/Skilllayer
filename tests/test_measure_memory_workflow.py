...
from src.skilllayer.runner.core import _memory_rating, build_measure_memory_artifacts
...
class TestGitignore:
    def test_gitignore_entry_written(self, tmp_path):
        ...
        assert ".skilllayer/memory_baseline.json" in gitignore.read_text("utf-8")
    ...
    def test_gitignore_not_duplicated(self, tmp_path):
        ...
        assert content.count(".skilllayer/memory_baseline.json") == 1
