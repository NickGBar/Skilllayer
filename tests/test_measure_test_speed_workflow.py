...
class TestBuildMeasureGitignore:
    def test_gitignore_entry_added_when_no_file(self, tmp_path):
        _run_builder(tmp_path, _make_run_result())
        gitignore = tmp_path / ".gitignore"
        assert gitignore.exists()
        assert ".skilllayer/test_speed_baseline.json" in gitignore.read_text()

    def test_gitignore_entry_added_to_existing_file(self, tmp_path):
        gitignore = tmp_path / ".gitignore"
