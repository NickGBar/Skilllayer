...
from src.skilllayer.runner.core import _profile_rating, build_profile_execution_artifacts
...
class TestGitignore:
    def test_gitignore_entry_written(self, tmp_path):
        ...
        assert gi.exists()
        assert ".skilllayer/profile_baseline.json" in gi.read_text("utf-8")
    ...
    def test_gitignore_entry_not_duplicated(self, tmp_path):
        ...
        assert content.count(".skilllayer/profile_baseline.json") == 1
