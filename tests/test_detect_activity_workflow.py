...
from src.skilllayer.runner.core import build_detect_activity_artifacts as _build_detect_activity_artifacts
...
def build_detect_activity_artifacts(repo: Path) -> dict[str, Any]:
    ...
    return _build_detect_activity_artifacts(repo, persist_snapshot=True)
...
class TestGitignore:
    def test_gitignore_not_created(self, tmp_path):
        ...
        assert result["gitignore_suggestions"] == [".skilllayer/repo_activity_snapshot.json"]
