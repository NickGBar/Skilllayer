...
# Routing/intent decision for "no rule matched the task". The router falls back
# to this task type. Whether the resulting workflow is then *allowed* to run is a
# separate, access-control concern handled by skilllayer.security.
FALLBACK_TASK_TYPE = "fix_simple_bug"
