...
OUTPUT_DIR = PROJECT_ROOT / "runs" / "p9_1_security_review_kit"
...
def run_security_check(write_outputs: bool = True) -> dict[str, Any]:
    ...
    report = {
        ...
        "outputs": {
            "security_docs_check": "runs/p9_1_security_review_kit/security_docs_check.json",
            "security_check_output": "runs/p9_1_security_review_kit/security_check_output.json",
            "report": "runs/p9_1_security_review_kit/report.json",
        },
    }
    if write_outputs:
