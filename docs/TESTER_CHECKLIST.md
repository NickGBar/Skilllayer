...
- [ ] Anonymous telemetry export generated with `python -m skilllayer telemetry-export`.
- [ ] Telemetry export manually reviewed before sharing.
- [ ] Feedback submitted through `FEEDBACK_TEMPLATE.md` or GitHub issue.

Please do not share private code, raw task text, secrets, screenshots, private
diffs, or unreviewed telemetry exports.
