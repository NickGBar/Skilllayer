...
if (-not (Test-Path $Python)) {
    ...
    Write-Host "Reason: No .venv Python found. Run scripts\install.ps1 first." -ForegroundColor Red
    exit 1
}
...
Run-Check "import path" @("-c", "import skilllayer; print(skilllayer.__file__)") $true
